...
class PriceImages with ChangeNotifier {
  List<PriceImage> _priceImages = [
    PriceImage(
      url: 'https://c8.alamy.com/comp/W94E3T/vector-abstract-backgrounds-of-a4-size-the-texture-brush-strokes-in-trendy-colors-mustard-blue-purple-coral-template-for-poster-card-brochure-W94E3T.jpg',
      title: 'عنوان الاول',
    ),
    PriceImage(
