...
import 'file:///F:/android/work/golf-project-flutter/lib/models/manager.dart';
                                  ...
                                  children: [
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          _filteredCSManagers[i].governorate,
                                          style: TextStyle(
                                            fontSize: 20,
                                          ),
                                        ),
                                        ...
                                        IconButton(
                                          ...
                                          onPressed: () {
                                            Navigator.of(context)
                                              ...
                                              MerchantLocMap.ROUTE_NAME,
                                              arguments: {
                                                'id': _filteredCSManagers[i].id,
                                                'title': _filteredCSManagers[i]
                                                    .name,
                                                'lat': _filteredCSManagers[i]
                                                    .lat,
                                                'lon': _filteredCSManagers[i]
                                                    .lon,
                                              },
                                            );
                                          },
